...
/*
new version for Chronon and Athlon tubes
Chronon column format changed: files have 58 columns beginning 
with system version VA20A (five new columns added at the end)
based on Somatom.go Bata 18Oct2017 Travis DePrey hack
*/
function loadTubeHistoryFormat58() {
	var thFormat = {};
	thFormat.numCols = 58;
	thFormat.delim = "\t";
	...
	thFormat.columnDef[53] = { id: 'milliAs', plot: 1, min: 0, max: NaN};
	thFormat.columnDef[54] = { id: 'UdcBegin', plot: 1, min: 0, max: NaN};
	thFormat.columnDef[55] = { id: 'UdcEnd', plot: 1, min: 0, max: NaN};
	thFormat.columnDef[56] = { id: 'testResult1', plot: 1, min: 0, max: NaN};
	thFormat.columnDef[57] = { id: 'testResult2', plot: 1, min: 0, max: NaN};
