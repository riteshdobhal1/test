...
(function() {
  ...
  paginationTemplate = "<div class='paginationwrap'><div class='btn-group pagination' role='group' aria-label='Basic example'><!-- button ng-class='{disabled: getCurrentPage() <= 0}' ng-click='stepPage(-numberOfPages)' type='button' class='btn btn-secondary'>{{getPaginatorLabels().first}}</button --><!-- button ng-show='showSectioning()' ng-class='{disabled: getCurrentPage() <= 0}' ng-click='jumpBack()' type='button' class='btn btn-outline-primary'>{{getPaginatorLabels().jumpBack}}</button --><button ng-class='{disabled: getCurrentPage() <= 0}' ng-click='stepPage(-1)' type='button' class='btn btn-outline-primary'>{{getPaginatorLabels().stepBack}}</button><button ng-class='{active: getCurrentPage() == page}' ng-repeat='page in pageSequence.data' ng-click='goToPage(page)' ng-bind='page + 1' type='button' class='btn btn-outline-primary'></button><button ng-class='{disabled: getCurrentPage() >= numberOfPages - 1}' ng-click='stepPage(1)' type='button' class='btn btn-outline-primary'>{{getPaginatorLabels().stepAhead}}</button><!-- button ng-show='showSectioning()' ng-class='{disabled: getCurrentPage() >= numberOfPages - 1}' ng-click='jumpAhead()' type='button' class='btn btn-outline-primary'>{{getPaginatorLabels().jumpAhead}}</button --><!-- button ng-class='{disabled: getCurrentPage() >= numberOfPages - 1}' ng-click='stepPage(numberOfPages)' type='button' class='btn btn-secondary'>{{getPaginatorLabels().last}}</button --></div></div>";
