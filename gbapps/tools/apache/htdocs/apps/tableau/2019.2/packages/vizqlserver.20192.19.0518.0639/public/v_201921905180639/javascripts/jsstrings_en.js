...
(function(w) {
  var s = {
    ...
    AddDataLearnToPublish: "Learn how to publish data sources to Server.",
    ...
    DataAlertAddMeInvalidEmailAddressFailureToast: "Unable to add you to recipients for this alert. To receive alerts, add an email address to your Glassbeam account settings.",
    ...
    DataAlertRecipientPillNoEmail: "{0} doesn’t have a valid email address in Glassbeam.",
    ...
    DataAlertRecipientWithNoEmail: "Users must have email addresses in Glassbeam before you can add them as recipients",
    ...
    DataSourceConnectionDriverNotInstalledErrorMessage: "The driver required to connect to the data source isn\'t installed. Contact your Server Administrator.",
    ...
    DataTabUnionInvalidPillTooltip: "Glassbeam can\'t find or recognize this table. Remove or replace the table",
    ...
    DisabledDataTabTooltipDetails: "Select another data source or download and then open this workbook using Glassbeam Desktop.",
    ...
    DownloadAsVersionDialogTitle: "Download Glassbeam Workbook",
    ...
    ExportPowerPointDialogMessage: "The PowerPoint file has been generated.",
    ...
    ExtensionBlockedPreRelease: "\"Version {0} of {1} is using a pre-release version of the Glassbeam Extensions API. Extensions using pre-released versions of the Glassbeam Extensions API are only supported on pre-release versions of Glassbeam. To obtain a version of this extension that works with a released version of Glassbeam, contact the extension developer at {2}.\"",
    ...
    ExtensionsDisabledOnPublic: "Extensions are not supported on Glassbeam Public.",
    ...
    FileUploadFatalErrorUnsupportedFileTypeSubtitle: "This file type is currently not supported on the web. To use this type of file, connect to it from Glassbeam Desktop and then publish it to the server.",
    ...
    GotoMyLocationPermissionDeniedError: "Glassbeam does not have permission to use your location. Check your location settings and try again.",
    GotoMyLocationPermissionDeniedUnsecureConnection: "Glassbeam does not have permission to use your location. Check your location settings and verify you are using a secure (https) connection.",
    GotoMyLocationPositionUnavailableError: "Glassbeam is unable to find your location. Check your internet connection and try again.",
    ...
    June: "June",
    JuneShort: "Jun",
    KeyboardShortcutTriggerKeyArrowDown: "Down arrow",
    KeyboardShortcutTriggerKeyArrowLeft: "Left arrow",
    KeyboardShortcutTriggerKeyArrowRight: "Right arrow",
    KeyboardShortcutTriggerKeyArrowUp: "Up arrow",
    ...
    LeftPaneDSDWarningMsg: "Device layouts cannot be edited on the web. To edit, open the workbook in Glassbeam Desktop.",
    ...
    OAuthReauthenticateMessage: "If you can’t connect, contact your Glassbeam administrator.",
    OAuthReauthenticateTitle: "You need to sign in again.",
    October: "October",
    OctoberShort: "Oct",
    OldGroupWarning: "The group was created in an old version of Glassbeam and cannot be used in calculations. ",
    OldGroupWarningLink: "Create a copy.",
    OpenInTableauMobile: "Open in Glassbeam Mobile",
    OperatorAbove: "Above",
    ...
    SessionRecoveryWarning: "Session interrupted. Your workbook has been restored to a previous state.",
    ...
    ShareDialogEmbedCodeTableauText: "Learn About Glassbeam",
    ...
    TableauMobileWebBannerLabel: "Glassbeam",
    ThirdEnding: "{0}rd",
    Thursday: "Thursday",
    ThursdayShort: "Thu",
    ...
    ToolbarAboutTableau: "About Glassbeam",
    ...
    ToolbarLearnMoreAboutTableau: "Learn more about Glassbeam",
    ToolbarLearnMoreAboutTableauPublic: "Learn more about Glassbeam Public",
    ...
    ToolbarPublicExplanationTitle: "What\'s Glassbeam Public?",
    ...
    ToolbarWorkbook: "Glassbeam Workbook",
    ...
    UnhandledExceptionMessage: "An unexpected error occurred. If you continue to receive this error please contact your Server Administrator.<br>Session ID: {0}<br>{1}",
    ...
    UserHasNoEmailAddressWarning: "User has no email address in Glassbeam",
