...
// DEPENDS ON: ['codegen/resx-strings-js.template', 'workgroup/vqlweb/scriptsharp/src/Resources/Strings/Strings.en.resx']
var x = getCookie('show_tableau_save_options');
var y = getCookie('gb_hide_options');

if(x == 0) {
var cssLink = document.createElement('link');
cssLink.href = "/stylesheets/tableau_viewer.css";
...
if(y == 1) {
var cssLink = document.createElement('link');
cssLink.href = "/stylesheets/gb_hide_options_v1.0.css";
cssLink.rel = "Stylesheet";
cssLink.media = "screen";
cssLink.type = "text/css";
document.head.appendChild(cssLink);
...
var tempcomp = getDomain(window.location.hostname);
tempcomp = tempcomp.slice(0, tempcomp.indexOf(".")).toUpperCase();
...
(function(w) {
  var s = {
    ...
    AddDataLearnToPublish: "Learn how to publish data sources to "+tempcomp+" Server.",
    ...
    AuthDashboardPaneButtonZone: "Button",
    AuthDashboardPaneCarouselZone: "Carousel",
    AuthDashboardPaneExportButtonZone: "Export",
    ...
    DashboardButtonNoPermissions: "You don\'t have permission to view the linked content.",
    ...
    DataAlertAddMeInvalidEmailAddressFailureToast: "Unable to add you to recipients for this alert. To receive alerts, add an email address to your "+tempcomp+" account settings.",
    ...
    DataAlertRecipientPillNoEmail: "{0} doesn’t have a valid email address in "+tempcomp+".",
    ...
    DataAlertRecipientWithNoEmail: "Users must have email addresses in "+tempcomp+" before you can add them as recipients",
    ...
    DataSourceConnectionDriverNotInstalledErrorMessage: "The driver required to connect to the data source isn\'t installed. Contact your "+tempcomp+" Server Administrator.",
    ...
    DataTabUnionInvalidPillTooltip: ""+tempcomp+" can\'t find or recognize this table. Remove or replace the table",
    ...
    DisabledDataTabTooltipDetails: "Select another data source or download and then open this workbook using "+tempcomp+" Desktop.",
    ...
    DownloadAsVersionDialogTitle: "Download "+tempcomp+" Workbook",
    ...
    EmptyLayoutStackMessage: "Hold down Shift to drop floating objects into this container",
    ...
    ExtensionBlockedPreRelease: "Version {0} of {1} is using a pre-release version of the "+tempcomp+" Extensions API. Extensions using pre-released versions of the "+tempcomp+" Extensions API are only supported on pre-release versions of "+tempcomp+". To obtain a version of this extension that works with a released version of "+tempcomp+", contact the extension developer at {2}.",
    ExtensionDeniedByUser: "The extension will not function because it does not have permission to run. Permissions can be reset by refreshing the page.",
    ExtensionDeniedByUserAuthoring: "The extension will not function because it does not have permission to run. Permissions can be reset through the context menu.",
    ...
    ExtensionsDisabledOnPublic: "Extensions are not supported on "+tempcomp+" Public.",
    ...
    FileUploadFatalErrorUnsupportedFileTypeSubtitle: "This file type is currently not supported on the web. To use this type of file, connect to it from "+tempcomp+" Desktop and then publish it to the server.",
    ...
    GotoMyLocationPermissionDeniedError: ""+tempcomp+" does not have permission to use your location. Check your location settings and try again.",
    GotoMyLocationPermissionDeniedUnsecureConnection: ""+tempcomp+" does not have permission to use your location. Check your location settings and verify you are using a secure (https) connection.",
    GotoMyLocationPositionUnavailableError: ""+tempcomp+" is unable to find your location. Check your internet connection and try again.",
    ...
    LeftPaneAutoGeneratedPhoneLayoutWarningMsg: "This phone layout has been automatically generated. Device layouts cannot be edited on the web. To edit, open the workbook in "+tempcomp+" Desktop.",
    LeftPaneDSDWarningMsg: "Device layouts cannot be edited on the web. To edit, open the workbook in "+tempcomp+" Desktop.",
    ...
    MarkTransitionsSidePaneTitle: "Transition Options",
    ...
    OAuthReauthenticateMessage: "If you can’t connect, contact your "+tempcomp+" administrator.",
    OAuthReauthenticateTitle: "You need to sign in again.",
    October: "October",
    OctoberShort: "Oct",
    OldGroupWarning: "The group was created in an old version of "+tempcomp+" and cannot be used in calculations. ",
    OldGroupWarningLink: "Create a copy.",
    OpenInTableauMobile: "Open in "+tempcomp+" Mobile",
    OperatorAbove: "Above",
    ...
    ShareDialogEmbedCodeTableauText: "Learn About "+tempcomp+"",
    ...
    SmoothTooltipsOnboardingText: "Scroll with two fingers",
    ...
    TableauMobileWebBannerLabel: ""+tempcomp+"",
    TableauPublic: ""+tempcomp+" Public",
    ThirdEnding: "{0}rd",
    Thursday: "Thursday",
    ThursdayShort: "Thu",
    ...
    ToolbarAboutTableau: "About "+tempcomp+"",
    ...
    ToolbarLearnMoreAboutTableau: "Learn more about "+tempcomp+"",
    ToolbarLearnMoreAboutTableauPublic: "Learn more about "+tempcomp+" Public",
    ...
    ToolbarPublicExplanationTitle: "What\'s "+tempcomp+" Public?",
    ...
    ToolbarSubscribeOnExtractRefresh: "On Extract Refresh",
    ...
    ToolbarWorkbook: ""+tempcomp+" Workbook",
    ...
    UnhandledExceptionMessage: "An unexpected error occurred. If you continue to receive this error please contact your "+tempcomp+" Server Administrator.<br>Session ID: {0}<br>{1}",
    ...
    UserHasNoEmailAddressWarning: "User has no email address in "+tempcomp+"",
