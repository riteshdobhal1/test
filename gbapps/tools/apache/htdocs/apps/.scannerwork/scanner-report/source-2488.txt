...
(function(w) {
  var s = {
    ...
    CreateConnectionToDataMarketplace: "Data Marketplace",
    CreateConnectionToDataMarketplaceErrorMessage: "Error Loading the Data Marketplace Dataset",
    ...
    DeviceLayoutTableauMobileApp: ""+tempcomp+" Mobile App",
    DeviceLayoutTableauMobileAppTooltip: "Adjusts the preview frame to show available screen size for devices running "+tempcomp+" Mobile",
    DeviceModel: "Model",
    ...
    EmptyLayoutStackMessage: "placeholder DROP IT HERE text Story 1067341",
    ...
    ExtensionNotSupportedOnPublic: "Extension {0} Version {1} isn\'t currently supported on "+tempcomp+" Public.",
    ...
    ExtensionsDisabledOnPublic: "Extensions aren\'t currently supported on "+tempcomp+" Public.",
    ...
    ToolbarGoToTableauPublic: "Go to "+tempcomp+" Public",
    ...
    WebZoneDisabled: "Web Page Objects are disabled for this site. For more information, contact your "+tempcomp+" administrator.",
