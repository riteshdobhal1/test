...
function loadTubeHistoryFormat43() {
	...
	thFormat.columnDef[27] = { id: 'oil_pressure', plot: 1, min: 1300, max: 2500 };
	...
	thFormat.columnDef[33] = { id: 'arcings_one', plot: 1, min: 0, max: 1 };
	thFormat.columnDef[34] = { id: 'xc_drops', plot: 1, min: 0, max: 1 };
	thFormat.columnDef[35] = { id: 'arcings_both', plot: 1, min: 0, max: 1 };
