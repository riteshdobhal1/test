...
function selectParam(idSelection, nameMeas, doRefresh) {
	...
	if (nameMeas == "(none)") {
		...
		chart.graphs[idxGraph].valueAxis.title = getLabel(nameMeas);
