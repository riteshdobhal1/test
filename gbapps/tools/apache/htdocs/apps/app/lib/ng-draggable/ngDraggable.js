 ...
 */
angular.module("ngDraggable", []).service('ngDraggable', [
function() {
	...
	return {
		...
		link : function(scope, element, attrs) {
			...
			var onlongpress = function(evt) {
				...
				_mx = ngDraggable.inputEvent(evt).pageX;
				//ngDraggable.getEventProp(evt, 'pageX');
				_my = ngDraggable.inputEvent(evt).pageY;
				//ngDraggable.getEventProp(evt, 'pageY');
	...
	return {
		...
		link : function(scope, element, attrs) {
			...
			var hitTest = function(x, y) {
				...
				// ngDraggable.getPrivOffset(element);
	...
	return {
		...
		link : function(scope, element, attrs) {
			...
			var onDragStart = function(evt, obj, elm) {
				...
				_dragOffset = element[0].getBoundingClientRect();
				//ngDraggable.getPrivOffset(element);
			};
			var onDragMove = function(evt, obj) {
				if (_allowClone) {
